...
export const metadata: Metadata = {
  openGraph: { images: [{ url: "https://more.sagehairclinic.com/og/c-evaluation.webp", width: 1200, height: 630, alt: "Complimentary hair evaluation at Sage Hair Clinic in Metuchen, NJ" }] },
  twitter: { card: "summary_large_image", images: ["https://more.sagehairclinic.com/og/c-evaluation.webp"] },
  title: 'Free Hair Loss Evaluation in Metuchen, NJ | Sage Hair Clinic',
