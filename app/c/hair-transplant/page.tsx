...
export const metadata: Metadata = {
  openGraph: { images: [{ url: "https://more.sagehairclinic.com/og/c-hair-transplant.webp", width: 1200, height: 630, alt: "Hair transplant consultation at Sage Hair Clinic in Metuchen, NJ" }] },
  twitter: { card: "summary_large_image", images: ["https://more.sagehairclinic.com/og/c-hair-transplant.webp"] },
  title: 'Hair Transplant Consultation in Metuchen, NJ | Sage Hair Clinic',
